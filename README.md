...
Pueden encontrar como instalar todo [acá](https://pdepre.ludat.io/guides/entorno/)

Si tienen algún problema usando Stack, revisen si es alguno de los mencionados acá: https://pdepre.ludat.io/guides/problemas/, si no manden un mail pidiendo ayuda.
...
Dejo un link a una guía ya escrita para otro curso que está muy bien explicada: https://pdepre.ludat.io/guides/entorno/#editor-de-texto
...
- Abrir el intérprete para probar cosas corriendo este comando (estando ubicado en la carpeta del proyecto): `stack ghci`. Una vez abierto el intérprete, probá escribir `doble 5` y darle enter.

- Escribir nuevo código en `src/Library.hs`, por ejemplo: `triple x = x * 3`, luego, en el intérprete escribí `:r` y dale enter para que recargue los archivos guardados, y ahora deberías poder escribir `triple 5` y darle enter y ver el resultado.
